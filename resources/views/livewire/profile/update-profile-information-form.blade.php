...
new class extends Component
{
    ...
    public function mount(): void
    {
        ...
        $this->avatar = auth()->user()->getMedia('*')->last()->getUrl();
    }
    ...
    public function updateProfileInformation(): void
    {
        ...
        $latest_tmp_file = $user->latest_temporary_file;
        if ($latest_tmp_file) {
            $user->addMedia(storage_path('app/public/avatars/tmp/' . $latest_tmp_file->folder . '/' . $latest_tmp_file->filename))
...
<section>
    ...
    <form wire:submit="updateProfileInformation" class="mt-6 space-y-6">
        ...
        <div>
            <x-upload-file name="avatar" id="avatar" label="Avatar" wire:model="avatar"/>
        </div>
